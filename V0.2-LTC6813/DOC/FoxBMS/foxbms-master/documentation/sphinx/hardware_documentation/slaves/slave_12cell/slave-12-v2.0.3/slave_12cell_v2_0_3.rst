...
.. note::
   ...
   The following description only applies for the |BMS-Slave| hardware versions ``2.0.3`` to ``2.1.1``.
...
The pinout of the isoSPI connectors is described in :numref:`table %s <daisy_input_connectors_12>` and :numref:`table %s <daisy_output_connectors_12>`.

.. figure:: ./twocon.png
   :width: 5 %

.. _daisy_input_connectors_12:
